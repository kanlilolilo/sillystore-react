...
function SingleProduct() {
  return (
    <div className={`${styles.product} cursor-pointer w-[240px] h-[240px] flex rounded-3xl mx-auto mb-3`}>
      <div className="w-[240px] h-10 bg-basicbluedark rounded-full mt-auto border-solid border-black border-2">
        <h1 className=" text-lg text-white mt-0.5 px-4 max-w-[200px] truncate cursor-default">Kharua's super mooie tshirt</h1>
        <div className="w-10 h-10 bg-borderblue rounded-full -mt-8 ml-auto -mr-0.5 border-solid border-black border-2 cursor-pointer">
